...
//                   <span className="text-xl font-normal text-[#9810FA] ml-0.5">
//                     365
//                   </span>
//                 </div>
...
//               AtStake365, we are committed to promoting responsible gambling
//               practices. We believe in creating a safe and enjoyable gaming
//               environment for all players.
//             </p>
//             <div className="flex items-center space-x-2 text-gray-700">
//               <Mail className="w-4 h-4 text-[#9810FA]" />
//               <span className="text-sm">Stake365@gmail.com</span>
//             </div>
//           </div>
...
//                 <a
//                   href="#about"
//                   className="text-gray-600 hover:text-[#9810FA] transition-colors duration-200 text-sm flex items-center group"
//                 >
...
//               Please ensure you are 18 years or older to participate, and
//               remember to play responsibly. Your well-being is our top priority.
//             </p>
//             <div className="flex flex-col space-y-2">
//               <a
//                 href="#support"
//                 className="text-[#9810FA] hover:text-purple-600 transition-colors duration-200 text-sm font-medium"
//               >
//                 Support Center
//               </a>
//               <a
...
//               <a
//                 href="#contact"
//                 className="text-gray-500 hover:text-[#9810FA] transition-colors duration-200"
//               >
//                 Contact Us
//               </a>
//               <a
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/About-us" className="text-gray-600 hover:text-[#9810FA] transition-colors duration-200 text-sm flex items-center group">
                  <Users className="w-4 h-4 mr-2 opacity-60 group-hover:opacity-100" />
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/frequently-asked-Question" className="text-gray-600 hover:text-[#9810FA] transition-colors duration-200 text-sm flex items-center group">
                  <HelpCircle className="w-4 h-4 mr-2 opacity-60 group-hover:opacity-100" />
                  FAQ's
                </Link>
              </li>
              <li>
                <Link to="/Privacy-policy" className="text-gray-600 hover:text-[#9810FA] transition-colors duration-200 text-sm flex items-center group">
                  <Shield className="w-4 h-4 mr-2 opacity-60 group-hover:opacity-100" />
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="/terms-and-conditions" className="text-gray-600 hover:text-[#9810FA] transition-colors duration-200 text-sm flex items-center group">
                  <FileText className="w-4 h-4 mr-2 opacity-60 group-hover:opacity-100" />
                  Terms & Conditions
                </Link>
              </li>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/casino/originals" className="text-gray-600 hover:text-[#9810FA] transition-colors duration-200 text-sm flex items-center group">
                  <div className="w-4 h-4 mr-2 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full opacity-60 group-hover:opacity-100"></div>
                  Casino Original
                </Link>
              </li>
              <li>
                <Link to="/sports/liveBetting" className="text-gray-600 hover:text-[#9810FA] transition-colors duration-200 text-sm flex items-center group">
                  <Trophy className="w-4 h-4 mr-2 opacity-60 group-hover:opacity-100" />
                  Sports Betting
                </Link>
              </li>
              <li>
                <Link to="/casino/LiveCasinoGames" className="text-gray-600 hover:text-[#9810FA] transition-colors duration-200 text-sm flex items-center group">
                  <div className="w-4 h-4 mr-2 bg-gradient-to-br from-red-500 to-pink-500 rounded-full opacity-60 group-hover:opacity-100"></div>
                  Live Casino
                </Link>
              </li>
              <li>
                <Link to="/casino/slotsGames" className="text-gray-600 hover:text-[#9810FA] transition-colors duration-200 text-sm flex items-center group">
                  <div className="w-4 h-4 mr-2 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full opacity-60 group-hover:opacity-100"></div>
                  Slot Games
                </Link>
              </li>
