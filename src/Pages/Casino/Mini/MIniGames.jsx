...
const MiniGames = () => {
 const games = [
  ...
  { id: 16, name: 'Bonuses Bonanza', image: '/api/placeholder/200/200' },
  { id: 17, name: 'Booster Run', image: '/api/placeholder/200/200' },
  { id: 18, name: 'Bonuses Bonanza', image: '/api/placeholder/200/200' },
  { id: 19, name: 'Booster Run', image: '/api/placeholder/200/200' },
