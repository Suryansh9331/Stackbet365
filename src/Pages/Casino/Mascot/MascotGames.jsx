...
const MascotGames = () => {
 const games = [
  ...
  { id: 9, name: 'HolyX', image: '/api/placeholder/200/200' },
  { id: 10, name: 'Smash', image: '/api/placeholder/200/200' },
  { id: 11, name: 'HolyX', image: '/api/placeholder/200/200' },
  { id: 12, name: 'Smash', image: '/api/placeholder/200/200' },
